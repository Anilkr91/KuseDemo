...
final class HomeViewController: StatusBarAnimatableViewController {
    ...
    private lazy var cardModels: [CardContentViewModel] = [
        CardContentViewModel(primary: "GAME OF THE DAY",
                             ...
                             image: UIImage(named: "Background")!.resize(toWidth: UIScreen.main.bounds.size.width * (1/GlobalConstants.cardHighlightedFactor))),
        ...
        CardContentViewModel(primary: "LET'S PLAY",
                             ...
                             image: #imageLiteral(resourceName: "img3").resize(toWidth: UIScreen.main.bounds.size.width * (1/GlobalConstants.cardHighlightedFactor)))
    ]
...
extension HomeViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "card", for: indexPath) as! CardCollectionViewCell
         ...
         cell.cardContentView.imageView.kf.setImage(with: url)
//        cell.cardContentView.backgroundImage?.kf.set
        
//            .kf.setImage(with: url)
        
//        cell.cardContentView.backgroundImage =
...
//        let cardModel = cardModels[indexPath.row]
        ...
        let vc = storyboard!.instantiateViewController(withIdentifier: "YoutubePlayViewController") as! YoutubePlayViewController
        vc.object = arrVideos[indexPath.row]
