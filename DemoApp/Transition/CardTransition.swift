...
final class CardTransition: NSObject, UIViewControllerTransitioningDelegate {
    ...
    private func animationController(forPresented presented: UIViewController, presenting: UIViewController, source: UINavigationController) -> UIViewControllerAnimatedTransitioning? {
